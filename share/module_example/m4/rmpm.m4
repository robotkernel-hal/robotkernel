...
AC_DEFUN([RMPM_CHECK_MODULES], 
         ...
         if test $tmp = 0; then
             ...
             $1[]_CFLAGS=$(/home/f_soft/bin/ctool --allow-beta --noquotes --c++ --compiler-flags --arch=$rmpm_host $2)
             $1[]_LIBS=$(/home/f_soft/bin/ctool --allow-beta --noquotes --c++ --linker-flags --arch=$rmpm_host $2)
             $1[]_BASE=$(/home/f_soft/bin/pkgtool --allow-beta --key=PKGROOT $2)
