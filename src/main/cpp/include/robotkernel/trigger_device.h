//! robotkernel trigger device class
/*!
...
#ifndef __ROBOTKERNEL__TRIGGER_DEVICE_H__
#define __ROBOTKERNEL__TRIGGER_DEVICE_H__
    ...
    public device
{
    ...
    public:
        //! trigger device construction
        /*!
         * \param[in] owner     Name of owning module/bridge/service_provider...
         * \param[in] name      Name of trigger device.
...
#endif // __ROBOTKERNEL__TRIGGER_DEVICE_H__
